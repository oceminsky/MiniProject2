...
state_pop_air <- right_join(state_sf, pop_air , by ="State")
```
...
server <- function(input, output, session) {
  ...
  output$ourmap <- renderLeaflet({
    ...
    colors <- pal(state_air_pop[[impact_variable]])
...
parks_pop <- full_parks |>
    ...
    summarize(num_parks = n()) |>
    left_join(population, by = state) |>
    mutate(density = parse_number(density),
         population = parse_number(population),
         change_numeric = parse_number(change))
...
>>>>>>> f392dcfdee55aae27d437c33d338da7fef13f95f
>>>>>>> 807dfeca98e02d303b505b73e74ebdf757526e9e
