...
In this project, we explore how state park data is related to population and the environment, specifically air quality. We are interested in examining if and how state population and air quality data are connected to the number and types of parks found within each state. We were motivated to engage with this data because of our love of the outdoors and our experiences visiting state and national parks. 
