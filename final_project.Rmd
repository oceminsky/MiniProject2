...
labels <- c("air_quality_index" = "Air Quality Index", "unhealt_days" = "Unhealthy Days in 2024", "toxin_concentration" = "Toxin Concentration (lbs//mi²)")
...
parks_pop <- full_parks |>
    ...
    labels <- c("population" = "Population (2025)", "pop_density" = "Population Density", "change_numeric" = "% Change in Population")
