...
inputPanel(
  selectInput("airquality", label = "Air Quality Variable",
              choices = c("Air Quality Index" = "air_quality_index", "Unhealthy Days in 2024" = "unhealt_days", "Toxin Concentration (lbs//mi²)" = "toxin_concentration")),
  
  selectInput("population", label = "Population Variable",
              choices = c("Population (2025)" = "population", "Population Density" = "pop_density", "% Change in Population" = "change_numeric"))
)
...
labels <- c("Air Quality Index" = "air_quality_index", "Unhealthy Days in 2024" = "unhealt_days", "Toxin Concentration (lbs//mi²)" = "toxin_concentration")
